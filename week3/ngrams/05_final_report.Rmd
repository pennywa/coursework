...
```{r load-counts}
 years <- read_tsv(here("week3", "ngrams", "year_counts.tsv"), col_names = c("term", "year", "volume", "book_count"))
 totals <- read_csv(here("week3", "ngrams", "total_counts.csv"), col_names = c("year", "total_volume", "page_count", "book_count"))
```
